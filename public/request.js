...
function hidePrompt() {
    var prompt = document.getElementById('requestPrompt');
...
/* Function to mark pending swap as accepted in the database table (((trying to retrofit request into it))) */
function acceptSwap(){
	document.getElementById('requestSwap').addEventListener('click', function(event){
        ...
        req.open("POST", "/postRequest", true);
